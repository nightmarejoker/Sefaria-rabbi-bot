...
def format_text_response(text_data: Dict, language: str = "both") -> discord.Embed:
    ...
    if language.lower() == "english" and english_text:
        embed.description = truncate_text(english_text, 2000)
    elif language.lower() == "hebrew" and hebrew_text:
        embed.description = truncate_text(hebrew_text, 2000)
